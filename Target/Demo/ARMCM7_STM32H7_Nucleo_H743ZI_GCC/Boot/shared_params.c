 ...
 */
static volatile tSharedParamsBuffer sharedParamsBuffer __attribute__ ((section (".shared")));
...
static void SharedParamsWriteChecksum(void)
{
  ...
  /* Perform a dummy incomplete word write to work around ECC protection as
   * per AN5342. */
  *((volatile uint8_t*)&sharedParamsBuffer) = *((volatile uint8_t*)&sharedParamsBuffer);
